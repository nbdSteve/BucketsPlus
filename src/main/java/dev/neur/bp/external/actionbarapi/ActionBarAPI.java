package dev.neur.bp.external.actionbarapi;
...
public class ActionBarAPI {
    ...
    public static void sendActionBar(final Player player, final String message, int duration) {
        ...
        if (duration >= 0) {
            ...
            }.runTaskLater(BucketsPlus.getPlugin(BucketsPlus.class), duration + 1);
        }
        ...
        while (duration > 40) {
            ...
            }.runTaskLater(BucketsPlus.getPlugin(BucketsPlus.class), (long) duration);
        }
    }
